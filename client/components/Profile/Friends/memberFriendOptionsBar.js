                  ...
                  render={({ field: { onChange, value } }) => (
                    <FormControl variant="filled">
                      ...
                      <FormHelperText style={{ color: "red" }}>
                        {errors.categorySelect && errors.categorySelect.message}
                      </FormHelperText>
                    </FormControl>
                  )}
                />
