      ...
      >
        ...
        <Stack spacing={4}>
          <FormControl fullWidth>
            ...
            <Select labelId="quest-label" id="quest-label-select" label="Quest">
              <MenuItem>Wo weee</MenuItem>
              <MenuItem>Oooh wee</MenuItem>
              <MenuItem>Hahhahah </MenuItem>
            </Select>
            <FormHelperText>Select the Quest to post on.</FormHelperText>
          </FormControl>

          <TextField label="Title" helperText="Add a title for your post." />
          <TextField
            label="Description"
            multiline
            minRows={3}
