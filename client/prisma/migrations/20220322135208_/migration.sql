<<<<<<< HEAD:client/prisma/migrations/20220406043912_/migration.sql
-- CreateTable
...
-- AddForeignKey
ALTER TABLE `UserBadge` ADD CONSTRAINT `UserBadge_badgeId_fkey` FOREIGN KEY (`badgeId`) REFERENCES `Badge`(`badgeId`) ON DELETE RESTRICT ON UPDATE CASCADE;
>>>>>>> 1b52cd68680fb6502baec83c673576ac86229b30:client/prisma/migrations/20220322135208_/migration.sql
