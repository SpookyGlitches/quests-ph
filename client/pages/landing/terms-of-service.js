    ...
    <LandingLayout>
      <Container component="main" sx={{ mt: 4, mb: 8 }}>
        ...
        >
          ...
          use of Quests Group&rsquo;s Website, located at quests-ph.com.
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          ...
          conditions. Do not continue to use Quests if you do not agree to take
        ...
        >
          ...
          prevailing law of the Philippines. Any use of the above terminology or
        ...
        >
          We employ the use of cookies. By accessing Quests, you agreed to use
          cookies in agreement with the Quests Group&rsquo;s Privacy Policy.
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          Unless otherwise stated, Quests Group and/or its licensors own the
          intellectual property rights for all material on Quests. All
          intellectual property rights are reserved. You may access this from
          Quests for your own personal use subjected to restrictions set in
        ...
        >
          <ul>
            <li>Republish material from Quests</li>
            <li>Sell, rent or sub-license material from Quests</li>
            <li>Reproduce, duplicate or copy material from Quests</li>
            <li>Redistribute content from Quests</li>
          </ul>
        </Typography>
        <Typography
          variant="body1"
        ...
        >
          ...
          <Link
            ...
            passHref
          >
            <MuiLink>Terms And Conditions Template.</MuiLink>
          </Link>
        </Typography>
        <Typography
          variant="body1"
        ...
        >
          ...
          Quests Group does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Quests Group,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Quests Group
        ...
        >
          Quests Group reserves the right to monitor all Comments and to remove
        ...
        >
          You hereby grant Quests Group a non-exclusive license to use,
        ...
        >
          ...
          the hyperlink compensates the absence of Quests Group; and (d) the
        ...
        >
          ...
          sending an e-mail to Quests Group. Please include your name, your
        ...
        >
          No use of Quests Group&rsquo;s logo or other artwork will be allowed
